  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-between px-8 lg:px-20 max-w-7xl mx-auto left-0 right-0">
        ...
        {/* TOP tagline — original position, fixed visibility */}
        <div className="pt-32">
          {/* Dark strip behind green text so it's always readable */}
          <div className="inline-block">
            <div className="flex items-center gap-3 mb-1">
              <span className="w-8 h-[2px] bg-[#4E9141]" />
              <p
                className="text-[#4E9141] text-sm lg:text-base font-bold uppercase tracking-[0.2em]"
                style={{
                  textShadow: '0 0 20px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,1), 0 1px 3px rgba(0,0,0,1)',
                }}
              >
            ...
            <p
              className="text-white/80 text-sm pl-11 max-w-lg leading-relaxed"
        ...
        <div key={current} className="animate-slide-up pb-24 max-w-3xl">
          ...
          <p className="text-white/80 text-lg lg:text-xl font-light leading-relaxed mb-10 max-w-xl"
